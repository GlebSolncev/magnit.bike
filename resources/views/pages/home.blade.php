...
@section('content')
    ...
    <div class="wrapper fixed__footer">
                                ...
                                <ul class="main__menu">
                                    ...
                                    <li class="drop"><a href="portfolio-gutter-box-3.html">portfolio</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="portfolio-gutter-masonry-fullwide-4.html">Masonry Wide 4
                                                    Col </a></li>
                                            <li><a href="portfolio-gutter-box-3-carousel.html">carousel Gutter 3
                                                    Col </a></li>
                                ...
                                <nav id="mobile_dropdown">
                                    <ul>
                                        ...
                                        <li><a href="#">portfolio</a>
                                            <ul class="dropdown">
                                                <li><a href="portfolio-gutter-box-3.html">Boxed Gutter 3 Col</a></li>
                                                <li><a href="portfolio-gutter-full-wide-4.html">Wide Gutter 4 Col </a>
                                                </li>
                                                <li><a href="portfolio-card-box-3.html">Card Gutter 3 Col </a></li>
                                                <li><a href="portfolio-masonry-3.html">Masonry Box 3 Col </a></li>
                                                <li><a href="portfolio-gutter-masonry-fullwide-4.html">Masonry Wide 4
                                                ...
                                                <li><a href="portfolio-gutter-box-3-carousel.html">carousel Gutter 3
                                                        Col </a></li>
                                                <li><a href="portfolio-justified-box-3.html">justified box 3 Col</a>
                                                </li>
                                                <li><a href="single-portfolio-gallery.html">Portfolio Details </a></li>
                                            </ul>
                                        </li>
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-4 col-xs-12 float-right-style">
                        <div class="categories-menu mrg-xs">
                            ...
                            <div class="category-menu-list">
                                <ul>
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum2.png"> Women’s Clothing
                                    ...
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum3.png"> Man Fashion <i
                                    ...
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum4.png"> Computer & Office
                                            <i class="zmdi zmdi-chevron-right"></i></a>
                                        <div class="category-menu-dropdown">
                                    ...
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum5.png"> Jewelry & Watches
                                            <i class="zmdi zmdi-chevron-right"></i></a>
                                        <div class="category-menu-dropdown">
                                    ...
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum6.png"> Men’s Clothing <i
                                                    class="zmdi zmdi-chevron-right"></i></a>
                                        <div class="category-menu-dropdown">
                                            <div class="category-menu-dropdown-left">
                                    ...
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum7.png"> Bags & Shoes</a>
                                    </li>
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum8.png"> Toys & Kids & Baby</a>
                                    </li>
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum9.png"> Automobiles </a>
                                    </li>
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum10.png"> Jewelry & Watches</a>
                                    </li>
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum2.png"> Consumer
                                            Electronics</a></li>
                                    <li><a href="#"><img alt="" src="/assets/images/icons/thum3.png"> all
                                            Accessories</a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="only-banner ptb--100 bg__white">
            <div class="container">
                <div class="only-banner-img">
                    <a href="shop-sidebar.html"><img src="/assets/images/new-product/3.jpg" alt="new product"></a>
                </div>
            </div>
        </div>
        ...
        <div class="only-banner ptb--100 bg__white">
            <div class="container">
                <div class="only-banner-img">
                    <a href="shop-sidebar.html"><img src="/assets/images/new-product/6.jpg" alt="new product"></a>
                </div>
            </div>
        </div>
        <!-- Start Our Product Area -->
        ...
        <div class="only-banner bg__white">
            <div class="container">
                <div class="only-banner-img">
                    <a href="shop-sidebar.html"><img src="/assets/images/new-product/7.jpg" alt="new product"></a>
                </div>
            </div>
        </div>
        <!-- Start Our Product Area -->
